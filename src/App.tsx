import { ClaimButton, ConnectButton, MediaRenderer, useActiveAccount } from "thirdweb/react";
			...
			<div className="py-20">
				<>
					<div style={{display: 'flex', justifyContent: 'center', alignItems: 'center', marginBottom: '50px'}}>
						<MediaRenderer client={client} src="https://ipfs.io/ipfs/QmcQodSLHbrbuvgAQwQcUFojjThQrqm5S9yTD3iGMyNZnx/0.png" width="200"/>
					</div>
